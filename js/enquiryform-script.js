//  form script 
      ...
      (function () {
        ...
        const toastSuccessIcon = document.getElementById(
          "globalToastSuccessIcon",
        );
        const toastErrorIcon = document.getElementById("globalToastErrorIcon");
        const toastWarningIcon = document.getElementById(
          "globalToastWarningIcon",
        );
        ...
        function showToast(type, message) {
          ...
          toastWarningIcon.classList.add("hidden");
          ...
          if (type === "success") {
            ...
            toastWarningIcon.classList.remove("hidden");
          } else {
            toastIconWrap.className =
